  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="relative bg-navy-light/50 py-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-cyan/20 text-cyan border-cyan/30">Perks & Benefits</Badge>
            <h2 className="font-heading text-4xl font-bold mb-4">
              More Than Just a{' '}
      ...
      <section id="openings" className="relative container mx-auto px-4 py-24">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-violet/20 text-violet border-violet/30">Open Positions</Badge>
          <h2 className="font-heading text-4xl font-bold mb-4">
            Join Our{' '}
